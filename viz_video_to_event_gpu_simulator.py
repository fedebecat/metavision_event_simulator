...
def parse_args(only_default_values=False):
    ...
    parser.add_argument('--path', default='test', help='path towards image or video dataset')
    ...
    parser.add_argument('--batch-size', default=1, type=int, help="grab clips of this duration")
    ...
    parser.add_argument('--min-frames-per-batch', default=1, type=int, help="minimum frames per batch to construct "
                                                                            "the event tensor")
    parser.add_argument('--max-frames-per-batch', default=2, type=int, help="maximum frames per batch to construct "
                                                                             "the event tensor")
    parser.add_argument('--num-workers', default=12, type=int, help="dataset number of workers")
